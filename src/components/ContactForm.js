...
const ContactForm = () => {
  ...
  const handleSendMail = async (e) => {
    ...
    try {
      ...
      const serviceID = "service_ybcabmi";
      const templateID = "template_ixizr58";
      const public_key = "H607iAgskFjbvxlHq";
      const form = e.target;
      await emailjs.sendForm(serviceID, templateID, form, public_key);
